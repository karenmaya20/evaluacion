...
function iniciarEntorno() {
	...
	if (eScorm) {
		...
		iniciarArreglo(calificacionSCORM);// iniciamos arreglo con valores en 0
	}// fin eScorm
}// fin iniciarEntorno
...
function enviarDatosSCORM() {
	...
	if (conectividadSCORM !== undefined) {
		...
		// si todas las evaluaciones han sido contestadas terminar el scorm
...
// total = numero de reactivos de la actividad
